...
Spectator.describe Geode::Degrees do
    ...
    context "with an angle of a different type" do
      it "compares angles" do
        aggregate_failures do
          ...
          expect(Geode::Degrees(Float64).quarter <=> Geode::Gradians(Float64).third).to eq(-1)
    ...
    context "with an angle of a different type" do
      it "compares angles" do
        aggregate_failures do
          ...
          expect(Geode::Degrees(Float64).half < Geode::Gradians(Float64).zero).to be_false
    ...
    context "with an angle of a different type" do
      it "compares angles" do
        aggregate_failures do
          ...
          expect(Geode::Degrees(Float64).half > Geode::Gradians(Float64).zero).to be_true
          expect(Geode::Degrees(Float64).quarter > Geode::Turns(Float64).quarter).to be_false
        end
      end
    end
  ...
  describe "#&*" do
    it "multiples the value" do
      expect(Geode::Degrees.new(3) &* 2).to eq(Geode::Degrees.new(6))
    end
  end
