    ...
    context "with an angle of a different type" do
      it "compares angles" do
        aggregate_failures do
          ...
          expect(Geode::Degrees(Float64).third <=> Geode::Radians(Float64).quarter).to eq(1)
        end
      end
    end
  end
    ...
    context "with an angle of a different type" do
      it "compares angles" do
        aggregate_failures do
          ...
          expect(Geode::Degrees(Float64).half < Geode::Radians(Float64).zero).to be_false
          expect(Geode::Degrees(Float64).quarter < Geode::Radians(Float64).quarter).to be_false
        end
      end
    end
  end
    ...
    context "with an angle of a different type" do
      it "compares angles" do
        aggregate_failures do
          expect(Geode::Degrees(Float64).third <= Geode::Radians(Float64).half).to be_true
          expect(Geode::Degrees(Float64).half <= Geode::Radians(Float64).zero).to be_false
          expect(Geode::Degrees(Float64).quarter <= Geode::Radians(Float64).quarter).to be_true
        end
      end
    end
  end
