      ...
      context "with an invertible matrix" do
        ...
        xit "returns an inverted matrix" do
          expect_within_tolerance(subject.not_nil!,
            0.078554526, 0.037441331, 0.01607307, -0.009094617, -0.018316645, -0.03622065, -0.04924129,
            -0.323449, -0.002516282, -0.045752335, 0.104363581, -0.04898534, 0.243622374, 0.204384165,
            0.186650973, 0.005432949, 0.058520638, -0.070498928, -0.001670777, -0.160507721, -0.161209703,
            0.186589143, -0.00454247, -0.003499211, -0.03821808, 0.016170787, -0.133777398, -0.080778816,
            0.189972307, 0.013771959, 0.020736009, -0.048739306, -0.010331799, -0.122869527, -0.14247961,
            0.064481701, 0.022716252, 0.028686288, -0.06374581, -0.002863456, -0.068283158, -0.069758238,
            0.016678179, 0.014839612, -0.002762752, 0.01469618, -0.001047774, -0.022437374, -0.023274531)
        end
      end

      context "with a non-invertible matrix" do
        let(matrix) { Geode::Matrix[[2, 3, 4], [4, 6, 8], [6, 9, 12]] }
